...
class Agent():
    ...
    def step(self, state, action, reward, next_state, done, agnt_idx):
        ...
        if len(self.memory) > BATCH_SIZE:
            for _ in range(5):
                ...
                self.learn(experiences, GAMMA, agnt_idx)
    ...
    def learn(self, experiences, gamma, agnt_idx):
    ...
    def save_weights(self, agnt_idx):
        torch.save(self.actor_local.state_dict(), f'ckpt_actor_{agnt_idx}.pth')
        torch.save(self.critic_local.state_dict(), f'ckpt_critic_{agnt_idx}.pth')
